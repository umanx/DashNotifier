...
public class DashNotifierSettingsActivity4 extends AbstractSettings {
	static final String ext = "4";
	...
	public static class PrefsFragment extends PreferenceFragment implements IconPicker.OnIconPickListener{
		...
		private static final String extNumber = "4";
		String[] prefText;
		String[] prefValues;
		@Override
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.dashnotifiersettings4);
