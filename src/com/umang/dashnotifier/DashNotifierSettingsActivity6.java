...
public class DashNotifierSettingsActivity6 extends AbstractSettings {
	static final String ext = "6";
	...
	public static class PrefsFragment extends PreferenceFragment implements IconPicker.OnIconPickListener{
		...
		private static final String extNumber = "6";
		String[] prefText;
		String[] prefValues;
		@Override
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.dashnotifiersettings6);
